...
public abstract class OakServerTestSupport extends TestSupport {
    ...
    public Option[] configuration() {
        ...
        versionResolver.setVersion("org.ow2.asm", "asm", "9.7.1");
        versionResolver.setVersion("org.ow2.asm", "asm-analysis", "9.7.1");
        versionResolver.setVersion("org.ow2.asm", "asm-commons", "9.7.1");
        versionResolver.setVersion("org.ow2.asm", "asm-tree", "9.7.1");
        versionResolver.setVersion("org.ow2.asm", "asm-util", "9.7.1");
    ...
    protected Option quickstart() {
        ...
        return composite(
                        ...
                        // grep -R 'NOT white' target/failsafe-reports/ | awk -F': Bundle ' '{print substr($2, 1,
                        // index($2, " is NOT "))}' | sort -u
